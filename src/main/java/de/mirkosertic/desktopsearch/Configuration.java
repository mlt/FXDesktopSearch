...
public class Configuration {
    ...
    private Configuration() {
        ...
        metaDataNameReplacement.put("date/time", "creation-date");
        metaDataNameReplacement.put("datetimeoriginal", "creation-date");
        metaDataNameReplacement.put("date/time original", "creation-date");
        metaDataNameReplacement.put("date/time digitized", "creation-date");
